...
echo "<table border=1>";
echo "<tr><th>User Id</th><th>Name</th><th>Mobile No</th><th>Email Id</th><th>Gender</th><th>Update</th><th>Delete</th></tr>";
 while($row=mysqli_fetch_array($res))
 {
	
	//print_r($row);
	echo "<tr><td>".$row['user_id']."</td><td>".$row['name']."</td><td>".$row['mobile_no']."</td><td>".$row['email']."</td><td>".$row['gender']."</td>
